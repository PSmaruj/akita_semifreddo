...
def main():
    ...
    for i, row in enumerate(df.itertuples(index=False)):
        ...
        torch.save(x_bar_slice_0[:,:,padding:-padding], f"{args.output_dir}/2000_lambda_{args.l}/{chrom}_{pred_start}_{pred_end}_slice.pt")
    ...
    df.to_csv(f"{args.output_dir}/2000_lambda_{args.l}_df.tsv", sep="\t", index=False)
