...
def main():
    ...
    patch_half_size = 7  # 7 bins on each side of the center dot -> 15x15 patch
    save_dir = "/scratch1/smaruj/natural_dots/dot_patches"
    ...
    with torch.no_grad():
        for orig_batch in orig_loader:
            ...
            for i in range(this_batch_size):
                ...
                # Extract and save 15x15 patch
                r_start = dot_r - patch_half_size
                r_end = dot_r + patch_half_size + 1
                c_start = dot_c - patch_half_size
                c_end = dot_c + patch_half_size + 1
                
                patch = og_maps[i, r_start:r_end, c_start:c_end]
                
                # Optional: check dimensions in case of boundary issues
