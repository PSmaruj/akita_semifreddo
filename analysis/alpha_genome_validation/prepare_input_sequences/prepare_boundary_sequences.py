"""
prepare_boundary_sequences.py
------------------------------
Generate designed FASTA files for boundary sequences, all folds.
Original FASTAs are written separately by prepare_original_sequences.py.

For flame: copy this file, set FEATURE = "flame".
For dot:   copy this file, set FEATURE = "dot" and update EDIT_SPEC.
"""
...
# Bin index and slice filename template for each edited bin.
...
for fold in FOLDS:
    ...
    results_dir = f"{BASE}/optimizations/boundaries/results/boundary_neg0p5/fold{fold}"
