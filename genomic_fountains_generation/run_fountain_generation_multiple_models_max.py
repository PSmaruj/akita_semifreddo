...
from ledidi_multiple_models_max import Ledidi
...
def main():
    ...
    model0 = SeqNN()
    model0.load_state_dict(torch.load("/scratch1/smaruj/Akita_pytorch_models/finetuned/mouse_models/Vian2018_Bcells/models/Akita_v2_mouse_Vian2018_Bcells_model0_from_scratch.pth", map_location=device))
    model0.eval()
    
    model1 = SeqNN()
    model1.load_state_dict(torch.load("/scratch1/smaruj/Akita_pytorch_models/finetuned/mouse_models/Vian2018_Bcells/models/Akita_v2_mouse_Vian2018_Bcells_model1_from_scratch.pth", map_location=device))
    model1.eval()
    
    model2 = SeqNN()
    model2.load_state_dict(torch.load("/scratch1/smaruj/Akita_pytorch_models/finetuned/mouse_models/Vian2018_Bcells/models/Akita_v2_mouse_Vian2018_Bcells_model2_from_scratch.pth", map_location=device))
    model2.eval()

    model3 = SeqNN()
    model3.load_state_dict(torch.load("/scratch1/smaruj/Akita_pytorch_models/finetuned/mouse_models/Vian2018_Bcells/models/Akita_v2_mouse_Vian2018_Bcells_model3_from_scratch.pth", map_location=device))
    model3.eval()
    ...
    for i, row in enumerate(df[0:3].itertuples(index=False)):
        ...
        target_m0 = torch.load(f"/scratch1/smaruj/generate_genomic_fountain/Bcell_targets_fold0/model0/{chrom}_{pred_start}_{pred_end}_target.pt", weights_only=True, map_location=device)
        target_m1 = torch.load(f"/scratch1/smaruj/generate_genomic_fountain/Bcell_targets_fold0/model1/{chrom}_{pred_start}_{pred_end}_target.pt", weights_only=True, map_location=device)
        ...
        tower_output_path_list = [f"/scratch1/smaruj/generate_genomic_fountain/Bcell_tower_out_fold0/model0/{chrom}_{pred_start}_{pred_end}_tower_out.pt",
                                ...
                                f"/scratch1/smaruj/generate_genomic_fountain/Bcell_tower_out_fold0/model2/{chrom}_{pred_start}_{pred_end}_tower_out.pt",
                                f"/scratch1/smaruj/generate_genomic_fountain/Bcell_tower_out_fold0/model3/{chrom}_{pred_start}_{pred_end}_tower_out.pt"]
        ...
        torch.save(x_bar_slice_0[:,:,padding:-padding], f"{args.pt_files_dir}/Bcell_results_max/{chrom}_{pred_start}_{pred_end}_slice.pt")
