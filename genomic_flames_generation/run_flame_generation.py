...
def main():
    ...
    for i, row in enumerate(df.itertuples(index=False)):
        ...
        target = torch.load(f"/scratch1/smaruj/generate_genomic_flame/targets_{target_c}/fold{FOLD}/{chrom}_{pred_start}_{pred_end}_target.pt", weights_only=True, map_location=device)
