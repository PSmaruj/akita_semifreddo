...
def main(args):
    ...
    df = pd.read_csv(f"/scratch1/smaruj/suppressing_CTCFs/results/fold{FOLD}_with_positions_steps.tsv", sep="\t")
    ...
    edited_dataset = BoundaryGenerationDataset(df, 
                                    ...
                                    f"/scratch1/smaruj/suppressing_CTCFs/results/fold{FOLD}/")
