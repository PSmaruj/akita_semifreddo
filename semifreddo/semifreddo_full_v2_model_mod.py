...
class Semifreddo():
    def __init__(self, 
                 ...
                 precomputed_full_output=None,  # pass tensor directly 
    ...
    def forward(self):    
        ...
        # Use precomputed tensor directly
        if self.precomputed_full_output is None:
            raise ValueError("You must provide precomputed_full_output tensor!")
        ...
        # Replace ±5 bins, 11 bins total
        x[:, :, edited_slice_0_start-2 : edited_slice_0_end+3] = sub_x_0[:, :, 3:8]
