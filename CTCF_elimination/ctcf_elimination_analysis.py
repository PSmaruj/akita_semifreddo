...
def main():
    ...
    # Load dataframe
    # -----------------------------
    df_path = f"/scratch1/smaruj/CTCF_elimination/gamma_{GAMMA}_repeated/fold{FOLD}_g{GAMMA}_genomic_windows_table_steps.tsv"
    ...
    edited_dataset = BoundaryGenerationDataset(
        ...
        f"/scratch1/smaruj/CTCF_elimination/gamma_{GAMMA}_repeated/fold{FOLD}/"
    )
    ...
    out_path = f"/scratch1/smaruj/CTCF_elimination/gamma_{GAMMA}_repeated/fold{FOLD}_g{GAMMA}_genomic_windows_table_results.tsv"
