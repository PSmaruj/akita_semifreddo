python CTCFs_screening.py \
    --ctcf_df /scratch1/smaruj/suppressing_CTCFs/results_repeated/new_ctcf_df.tsv \
    ...
    --output_df /scratch1/smaruj/suppressing_CTCFs/results_repeated/new_ctcf_df_with_SCD.tsv